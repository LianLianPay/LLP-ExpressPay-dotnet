<%@ Page Language="C#" AutoEventWireup="true" CodeFile="plainPay.aspx.cs" Inherits="plainPay" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="table_ui">
            ...
            <tr>
                ...
                <form id="form1" runat="server">
            		...
            		<asp:TextBox ID="WIDpaymod" name="WIDpaymod" Visible="false"  Text="plain" runat="server"></asp:TextBox>
					...
					<asp:Button id="button1" runat="server" Text="提交去支付" class="btn orange w100 mt10" OnClick="button1Clicked" />
                 </form>
                </td>
            </tr>
        </table>

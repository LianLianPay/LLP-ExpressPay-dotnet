<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prepositPay.aspx.cs" Inherits="prepositPay" %>
...
<body>
	  <header class="header">
        ...
        <span class="fr about"><a href="javascript:void(0)">关于</a>
        </span>
        </header>
        <section class="info">
           ...
           <tr>
            ...
            <tr>
                <td colspan="2">
            		...
            		<asp:TextBox ID="WIDpaymod" name="WIDpaymod" Visible="false"  Text="prepositPay" runat="server"></asp:TextBox>
					<asp:TextBox ID="WIDmoney_order" name="WIDmoney_order" Visible="false"  Text="0.01" runat="server"></asp:TextBox>
					<asp:TextBox ID="WIDname_goods" name="WIDname_goods" Visible="false"  Text="高级套房一间" runat="server"></asp:TextBox>
					<asp:Button id="fakeBtn" runat="server" ClientIDMode="Static"  Text="提交去支付" class="btn orange w100 mt10"  OnClientClick= "paySubmit(); return false;"/>
					<asp:Button id="button1" runat="server" ClientIDMode="Static"  Text="" style="display:none"  OnClick="button1Clicked"/>
...
function queryUserCard() {
    ...
    ajaxFunction('infoQuery.aspx?operate=query_bankcard_list&user_id=' + user_id, 'query_bankcard_list');

}

function queryCardBin(card_no) {
    ajaxFunction('infoQuery.aspx?operate=query_card_bin&card_no=' + card_no, 'query_card_bin');

           ...
           <tr>
            ...
            <tr>
                <td colspan="2" align="center">
              		<input type="button" onclick="goNext('plainPay.aspx')" class="btn orange w100 mt10" value="普通接入" />
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                 <input type="button" onclick="goNext('prepositPay.aspx')" class="btn orange w100 mt10" value="卡前置接入" />
                </td>
            </tr>
        </table>
        </form>

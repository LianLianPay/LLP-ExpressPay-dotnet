...
<body>
	<form name="inputForm"
		action='paySubmit.aspx' method=post>
		<table cellpadding="2" cellspacing="2">
			...
			<tr>
				...
				<td><input type="text" name="dt_order"
					value="<%= YinTongUtil.getCurrentDateTimeStr() %>">（格式：YYYYMMDDH24MISS）</td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="no_order"
					value="<%= YinTongUtil.getCurrentDateTimeStr() %>">（不重复的单号）</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="sign_type" readonly="readonly" value="<%= PartnerConfig.SIGN_TYPE %>">（RSA或MD5）</td>
			</tr>
			<tr>
				<td>支付结束回显url</td>
